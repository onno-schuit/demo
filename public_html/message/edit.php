...
/// Set all the processor options as well
    ...
    $preferences['message_membersofmygroups'] = !empty($form->membersofmygroups) ? 1 : 0;
    $preferences['message_userswiththeseroles'] = !empty($form->userswiththeseroles) ? $form->userswiththeseroles : '';
...
$preferences->userswiththeseroles  =  get_user_preferences( 'message_userswiththeseroles', '', $user->id);
$preferences->membersofmygroups  =  get_user_preferences( 'message_membersofmygroups', '', $user->id);
