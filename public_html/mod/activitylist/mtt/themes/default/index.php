...
<?php /* already in main THNK template <script type="text/javascript" src="<?php mttinfo('mtt_url'); ?>jquery/jquery-1.4.4.min.js"></script> */ ?>
...
$().ready(function(){
    ...
    //mytinytodo.instanceId = <?php echo (int)$_REQUEST['id']; ?>;
    // PLEASE NOTE: instanceId is NOT the course_modules.instance column, but the course_modules.id column! - Onno
    mytinytodo.instanceId = <?php echo $cm_id; ?>;
...
<div id="wrapper" style="width: 615px;">
<div id="container">
<div id="mtt_body">
...
<?php /* removed   <a href="#settings" id="settings"><?php _e('a_settings');?></a> */  ?>
 </span>
...
<?php /* removed <div class="mtt-tabs-add-button" title="<?php _e('list_new'); ?>"><span></span></div> */ ?>
 <div id="tabs_buttons">
<?php /* removed   <div class="mtt-tabs-select-button mtt-tabs-button" title="<?php _e('list_select'); ?>"><span></span></div> */ ?>
 </div>
...
<div style="display:none" class="form-row"><div class="h"><?php _e('tags');?></div>
...
<?php /* removed <li id="cmenu_move" class="mtt-menu-indicator" submenu="cmenulistscontainer"><div class="submenu-icon"></div><?php _e('action_move');?></li> */ ?>
