...
mytinytodoStorageAjax.prototype = 
{
	...
	{
		$.getJSON(this.mtt.mttUrl+'ajax.php?loadLists'+'&rnd='+Math.random()+'&instanceid='+this.mtt.instanceId, callback);
	},
...
*/
	...
	{
		$.post(this.mtt.mttUrl+'ajax.php?instanceid='+this.mtt.instanceId+'&editNote='+params.id, {id:params.id, note: params.note}, callback, 'json');
	},


	completeTask: function(params, callback)
	{
		$.post(this.mtt.mttUrl+'ajax.php?instanceid='+this.mtt.instanceId+'&completeTask='+params.id, { id:params.id, compl:params.compl }, callback, 'json');
	},


	deleteTask: function(params, callback)
	{
		$.post(this.mtt.mttUrl+'ajax.php?instanceid='+this.mtt.instanceId+'&deleteTask='+params.id, { id:params.id }, callback, 'json');
	},


	setPrio: function(params, callback)
	{
		$.getJSON(this.mtt.mttUrl+'ajax.php?instanceid='+this.mtt.instanceId+'&setPrio='+params.id+'&prio='+params.prio+'&rnd='+Math.random(), callback);
	},

	
	setSort: function(params, callback)
	{
		$.post(this.mtt.mttUrl+'ajax.php?instanceid='+this.mtt.instanceId+'&setSort', { list:params.list, sort:params.sort }, callback, 'json');
	},
	...
	changeOrder: function(params, callback)
	{
		...
		$.post(this.mtt.mttUrl+'ajax.php?instanceid='+this.mtt.instanceId+'&changeOrder', { order:order }, callback, 'json');
	},

	tagCloud: function(params, callback)
	{
		$.getJSON(this.mtt.mttUrl+'ajax.php?instanceid='+this.mtt.instanceId+'&tagCloud&list='+params.list+'&rnd='+Math.random(), callback);
	},

	moveTask: function(params, callback)
	{
		$.post(this.mtt.mttUrl+'ajax.php?instanceid='+this.mtt.instanceId+'&moveTask', { id:params.id, from:params.from, to:params.to }, callback, 'json');
	},

	parseTaskStr: function(params, callback)
	{
		$.post(this.mtt.mttUrl+'ajax.php?instanceid='+this.mtt.instanceId+'&parseTaskStr', { list:params.list, title:params.title, tag:params.tag }, callback, 'json');
	},
