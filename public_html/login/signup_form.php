...
class login_signup_form extends moodleform {
    function definition() {
        ...
        // HACK BY BAS BRANDS, ADD THESE PROFILE FIELDS TO THE SIGN UP PAGE
        $mform->addElement('text', 'description', get_string('jobtitle','theme_thnklink'), 'maxlength="120" size="30"');
        $mform->setType('description', PARAM_TEXT);
        $mform->addRule('description', get_string('missingjobtitle','theme_thnklink'), 'required', null, 'server');
        
        $mform->addElement('text', 'institution', get_string('employer','theme_thnklink'), 'maxlength="120" size="30"');
        $mform->setType('institution', PARAM_TEXT);
        $mform->addRule('institution', get_string('missingemployer','theme_thnklink'), 'required', null, 'server');
        // END OF HACK
