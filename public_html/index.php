 ...
 */
    ...
    //HACK TO FORCE REDIRECTION BAS BRANDS
    //this hack needs the mod_rewrite module to be active
    //content:
    ...
    require_once($CFG->dirroot .'/local/thnkredirect/thnkredirect.php');
    redirect_if_thnkuser($requested);
