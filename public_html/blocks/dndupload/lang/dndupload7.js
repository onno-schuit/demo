M.blocks_dndupload = {
    ...
    init: function(Y, sesskey, serverurl, courseid, loadingimg, maxsize, addimg) {
        ...
        var self = this;
        var els = document.getElementById('section-2');
        this.addpreviewelement(els);
        els.addEventListener('dragenter', function(e) {
            self.dragenter(e);
        }, false);
        els.addEventListener('dragleave', function(e) {
            self.dragleave(e);
        }, false);
        els.addEventListener('dragover', function(e) {
            self.dragover(e);
        }, false);
        els.addEventListener('drop', function(e) {
            self.drop(e);
        }, false);
